...
use parable::{define_G_test_template, define_test_skip, test_utils::*, Symbol};

const CRATE_DIR: &str = "tests/async-tests";

lazy_static! {
    static ref TEST_CRATE_ANALYZED: bool = run_parable_with_graph_dump_and(CRATE_DIR, ["--drop-poll"]);
}
