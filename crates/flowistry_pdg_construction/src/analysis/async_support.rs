...
impl<'tcx> SimpleInterpreter<'tcx> {
    ...
    pub fn interpret_body(tcx: TyCtxt<'tcx>, body: &Body<'tcx>) -> Result<Self, String> {
...
//         })
//         .compile(|result| {
//             let (bid, body) = result.as_body();
//             let interpreter = SimpleInterpreter::interpret_body(bid.def_id(), &body.body).unwrap();
//             assert_eq!()
//         })
//     }
// }
