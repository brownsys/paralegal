...
impl CommunityProp {
    ...
    pub fn check(&self) {
        let db_community_write = Label::new_intern("db_community_write");
        let community_delete_check = Label::new_intern("community_delete_check");
        let community_ban_check = Label::new_intern("community_ban_check");
